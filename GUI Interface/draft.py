...
while cap.isOpened():
    ...
    if success:
        ...
        if len(lis) == 8:
            ...
            if "(no detections)" in lis:
                cv2.rectangle(annotated_frame, (30, 20), (400, 70), (0, 0, 0), -1)
                cv2.putText(annotated_frame, "PCB Missing", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            elif ' 1 regulator' not in lis or ' 2 regulators' not in lis or ' 3 regulators' not in lis or ' 4 regulators'  not in lis or ' 5 regulators' not in lis:
                cv2.rectangle(annotated_frame, (30, 20), (400, 70), (0, 0, 0), -1)
        ...
        cv2.rectangle(annotated_frame, (0, 400), (700, 700), (0, 0, 0), -1)
        cv2.putText(annotated_frame, f'{results[0].verbose()}', (10, 450), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0), 1)
